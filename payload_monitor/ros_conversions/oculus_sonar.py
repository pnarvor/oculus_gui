...
# ros_message_types = {'oculus_sonar/OculusHeader'      : oculus_msg.OculusHeader,
#                      'oculus_sonar/OculusVersionInfo' : oculus_msg.OculusVersionInfo,
#                      'oculus_sonar/OculusStatus'      : oculus_msg.OculusStatus,
#                      'oculus_sonar/OculusFireConfig'  : oculus_msg.OculusFireConfig,
#                      'oculus_sonar/OculusPing'        : oculus_msg.OculusPing}
# 
# ros_converters = {oculus_msg.OculusHeader      : lambda msg: {'scalars' : from_OculusHeader(msg),      'vectors' : {}},
#                   oculus_msg.OculusVersionInfo : lambda msg: {'scalars' : from_OculusVersionInfo(msg), 'vectors' : {}},
#                   oculus_msg.OculusStatus      : lambda msg: {'scalars' : from_OculusStatus(msg),      'vectors' : {}},
#                   oculus_msg.OculusFireConfig  : lambda msg: {'scalars' : from_OculusFireConfig(msg),  'vectors' : {}},
#                   oculus_msg.OculusPing        : lambda msg: {'scalars' : from_OculusPing(msg),        'vectors' : {'data' : ('data',  msg.data)}}}

ros_converters = {
'oculus_sonar/OculusHeader'      : (oculus_msg.OculusHeader, 
...
def oculus_from_ros(msg):
    return ros_converters[type(msg)](msg)
