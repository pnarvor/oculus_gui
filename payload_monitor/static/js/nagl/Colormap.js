...
class Colormap
{
    constructor(gl, colormap = Colormap.Viridis())
    {
        this.gl = gl;
    ...
    load(data) {
        ...
        // leaving it as is for now (there are condition on filtering mode,
        // mipmap level and when size of texture is power of 2).
